const { Plugin, PluginSettingTab, Setting, TFile, Notice, Modal, Menu, FuzzySuggestModal, ItemView, setIcon, Platform } = require('obsidian');
...
// Stable per-device id, kept in localStorage so it never syncs. Used as the anonymous
// fallback for a map's author/editor when the user has not set an author name.
...
// The viewport (pan/zoom) is device-local and kept in localStorage, never written to the
// synced map file. Stripping these keys before serialising means pure navigation produces
// no file change -> no Obsidian Sync churn/conflict.
const stripViewportKeys = (d) => {
    const { zoom, offX, offY, viewports, centerWorldX, centerWorldY, ...rest } = d;
    return rest;
};
// Order-independent stringify: object keys sorted (arrays keep their order, which is
// meaningful for paths/z-order). Two maps built in a different draw order thus match.
...
const SVG_SYMBOL_CONFIG = {
    ...
    'cactus':      { size: 0.375,  align: 'center', marginX: 0, marginY: 0 },
...
const TRANSLATIONS = {
    de: {
        ...
        'variant.palm': 'Palme',
        'variant.cactus': 'Kaktus',
        'variant.forestDeciduous': 'Laubwald',
        'variant.forestConiferous': 'Nadelwald',
        // Varianten — Berge
        'variant.hill': 'Hügel',
        'variant.mountain': 'Berg',
        'variant.volcano': 'Vulkan',
        // Variants — buildings
        'variant.tent': 'Zelt',
        'variant.house': 'Haus',
        ...
        'settings.folderPickerPlaceholder': 'Ordner suchen …',
    ...
    en: {
        ...
        'variant.cactus': 'Cactus',
        'variant.forestDeciduous': 'Deciduous Forest',
        'variant.forestConiferous': 'Coniferous Forest',
        // Variants — Mountains
        'variant.hill': 'Hill',
        ...
        'settings.folderPickerPlaceholder': 'Search folders …',
        ...
        'guide.symbols.userSymbols': 'Your own symbols appear in the right-click menu below "System", named after your folder.',
    ...
    zh: {
        ...
        'variant.palm': '棕榈树',
        'variant.cactus': '仙人掌',
        'variant.forestDeciduous': '落叶林',
        'variant.forestConiferous': '针叶林',
        'variant.hill': '丘陵',
        'variant.mountain': '山脉',
        'variant.volcano': '火山',
        'variant.tent': '帐篷',
        ...
        'settings.folderPickerPlaceholder': '搜索文件夹 …',
        ...
        'guide.symbols.userSymbols': '自定义符号会显示在右键菜单中“系统”的下方，以你的文件夹命名。',
        'guide.drawing': '绘制模式',
    ...
    ru: {
        ...
        'variant.palm': 'Пальма',
        'variant.cactus': 'Кактус',
        'variant.forestDeciduous': 'Лиственный лес',
        'variant.forestConiferous': 'Хвойный лес',
        'variant.hill': 'Холм',
        'variant.mountain': 'Гора',
        'variant.volcano': 'Вулкан',
        ...
        'settings.folderPickerPlaceholder': 'Поиск папок …',
        ...
        'guide.symbols.userSymbols': 'Собственные символы появляются в контекстном меню под «Система», с именем вашей папки.',
    ...
    ja: {
        ...
        'variant.palm': 'ヤシの木',
        'variant.cactus': 'サボテン',
        'variant.forestDeciduous': '落葉樹林',
        'variant.forestConiferous': '針葉樹林',
        'variant.hill': '丘',
        'variant.mountain': '山',
        'variant.volcano': '火山',
        'variant.tent': 'テント',
        ...
        'settings.folderPickerPlaceholder': 'フォルダを検索 …',
        ...
        'guide.symbols.userSymbols': 'カスタムシンボルは右クリックメニューの「システム」の下に、フォルダ名で表示されます。',
        'guide.drawing': '描画モード',
    ...
    fr: {
        ...
        'variant.cactus': 'Cactus',
        'variant.forestDeciduous': 'Forêt de feuillus',
        'variant.forestConiferous': 'Forêt de conifères',
        'variant.hill': 'Colline',
        'variant.mountain': 'Montagne',
        'variant.volcano': 'Volcan',
        'variant.tent': 'Tente',
        ...
        'settings.folderPickerPlaceholder': 'Rechercher des dossiers …',
        ...
        'guide.symbols.userSymbols': 'Vos propres symboles apparaissent dans le menu contextuel sous « Système », au nom de votre dossier.',
    ...
    pt: {
        ...
        'variant.cactus': 'Cato',
        'variant.forestDeciduous': 'Floresta caducifólia',
        'variant.forestConiferous': 'Floresta conífera',
        'variant.hill': 'Colina',
        'variant.mountain': 'Montanha',
        'variant.volcano': 'Vulcão',
        'variant.tent': 'Tenda',
        'variant.house': 'Casa',
        ...
        'settings.folderPickerPlaceholder': 'Procurar pastas …',
        ...
        'guide.symbols.userSymbols': 'Os seus símbolos aparecem no menu de contexto abaixo de "Sistema", com o nome da sua pasta.',
    ...
    ko: {
        ...
        'variant.palm': '야자수',
        'variant.cactus': '선인장',
        'variant.forestDeciduous': '낙엽수림',
        'variant.forestConiferous': '침엽수림',
        'variant.hill': '언덕',
        'variant.mountain': '산',
        'variant.volcano': '화산',
        'variant.tent': '텐트',
        ...
        'settings.folderPickerPlaceholder': '폴더 검색 …',
        ...
        'guide.symbols.userSymbols': '사용자 심볼은 우클릭 메뉴에서 "시스템" 아래에 폴더 이름으로 표시됩니다.',
    ...
    es: {
        ...
        'variant.cactus': 'Cactus',
        'variant.forestDeciduous': 'Bosque caducifolio',
        'variant.forestConiferous': 'Bosque de coníferas',
        'variant.hill': 'Colina',
        'variant.mountain': 'Montaña',
        'variant.volcano': 'Volcán',
        'variant.tent': 'Tienda',
        'variant.house': 'Casa',
        ...
        'settings.folderPickerPlaceholder': 'Buscar carpetas …',
        'settings.userAssetsFound': '{n} gráficos encontrados.',
        ...
        'guide.symbols.userSymbols': 'Tus propios símbolos aparecen en el menú contextual debajo de «Sistema», con el nombre de tu carpeta.',
    ...
    pl: {
        ...
        'variant.palm': 'Palma',
        'variant.cactus': 'Kaktus',
        'variant.forestDeciduous': 'Las liściasty',
        'variant.forestConiferous': 'Las iglasty',
        'variant.hill': 'Wzgórze',
        'variant.mountain': 'Góra',
        'variant.volcano': 'Wulkan',
        'variant.tent': 'Namiot',
        'variant.house': 'Dom',
        ...
        'settings.folderPickerPlaceholder': 'Szukaj folderów …',
        ...
        'guide.symbols.userSymbols': 'Własne symbole pojawiają się w menu kontekstowym pod pozycją „System”, pod nazwą Twojego folderu.',
    ...
    it: {
        ...
        'variant.palm': 'Palma',
        'variant.cactus': 'Cactus',
        'variant.forestDeciduous': 'Bosco deciduo',
        'variant.forestConiferous': 'Bosco di conifere',
        'variant.hill': 'Collina',
        'variant.mountain': 'Montagna',
        'variant.volcano': 'Vulcano',
        'variant.tent': 'Tenda',
        'variant.house': 'Casa',
        ...
        'settings.folderPickerPlaceholder': 'Cerca cartelle …',
        ...
        'guide.symbols.userSymbols': 'I tuoi simboli compaiono nel menu contestuale sotto "Sistema", con il nome della tua cartella.',
...
class UserAssetRegistry {
    ...
    constructor(app, category) {
        ...
        this.keyPrefix = USER_ASSET_PREFIX + category.id + ':';
        this.assets = new Map();
        this.tree = null;
        this.rootPath = '';
        this.rootName = '';
    ...
    get isActive() {
        return !!this.rootPath && this.assets.size > 0;
    }
    ...
    makeAsset(file) {
        return {
            key: this.keyPrefix + file.relPath.slice(0, file.relPath.lastIndexOf('.')),
            label: file.label,
    ...
    // Vorgang; einmal Dekodiertes bleibt im Speicher.
        ...
        if (asset.decoded || asset.failed) return Promise.resolve(asset);
        if (asset.loading) return asset.loading;

        const gen = this.generation;
        asset.loading = (async () => {
            try {
                const data = asset.ext === 'svg'
                    ? await this.loadSvg(asset)
                    : { colorable: false, image: await this.loadBitmap(this.app.vault.adapter.getResourcePath(asset.filePath)) };

                // Zwischenzeitlich neu gescannt -> Ergebnis verwerfen.
                if (gen !== this.generation) return asset;

                if (!data || (!data.image && !data.pathData)) {
                    asset.failed = true;
                } else {
    ...
    async collectFiles(folder, out) {
        ...
        for (const filePath of listing.files || []) {
            ...
            if (!USER_ASSET_EXTENSIONS.includes(ext)) continue;

            const relPath = filePath.slice(this.rootPath.length + 1);
            out.push({
                filePath,
                ext,
                relPath,
                relDir: relPath.includes('/') ? relPath.slice(0, relPath.lastIndexOf('/')) : '',
                label: filename.slice(0, dot)
            });
        }

        for (const sub of listing.folders || []) {
            await this.collectFiles(sub, out);
        }
    }
    ...
    async decodeAt(key, shortSideCap) {
        ...
        try {
            ...
            return await this.loadBitmap(this.app.vault.adapter.getResourcePath(asset.filePath), shortSideCap);
        } catch (e) {
            console.warn(`Hex Cartographer: could not load user asset at high resolution ${asset.filePath}`, e);
            return null;
        }
    }
    ...
    async loadSvg(asset, cap = USER_ASSET_MAX_SHORT_SIDE) {
        ...
        if (this.kind === 'symbol') {
            const shapes = svg.querySelectorAll('path, circle, rect, ellipse, line, polyline, polygon, text, image, use');
            const paths = svg.querySelectorAll('path');
            if (shapes.length === 1 && paths.length === 1) {
                const pathData = paths[0].getAttribute('d');
                const stroke = paths[0].getAttribute('stroke');
                if (pathData && (!stroke || stroke === 'none')) {
                    return { colorable: true, pathData, viewBoxWidth, viewBoxHeight };
                }
            }
        }

        const image = await this.rasterizeSvg(svg, viewBoxWidth, viewBoxHeight, cap);
    ...
    async rasterizeSvg(svgEl, vbWidth, vbHeight, cap = USER_ASSET_MAX_SHORT_SIDE) {
        ...
        if (ratio >= 1) { // tall -> width is the short side
            ...
            height = cap;
            width = Math.max(1, Math.round(cap / ratio));
        }
    ...
    loadBitmap(src, cap = USER_ASSET_MAX_SHORT_SIDE) {
        return new Promise((resolve) => {
            const img = new Image();
            img.onload = () => resolve(cap ? this.downscale(img, cap) : img);
    ...
    insertIntoTree(asset) {
        let node = this.tree;
        if (asset.relDir) {
            for (const part of asset.relDir.split('/')) {
                let child = node.folders.find(f => f.name === part);
                if (!child) {
                    child = { name: part, folders: [], assets: [] };
...
class HexCartographerPlugin extends Plugin {
    async onload() {
        ...
        for (const category of USER_ASSET_CATEGORIES) {
            this.userAssets.set(category.id, new UserAssetRegistry(this.app, category));
        }
        this.userAssetsPromise = Promise.all(
            USER_ASSET_CATEGORIES.map(c => this.userAssets.get(c.id).load(this.settings[c.settingKey]))
        );

        this.registerAssetWatcher();
    ...
    async createNewHexMap(targetFile = null) {
        ...
        const creator = (this.settings.authorName || '').trim() || getDeviceId();
        const initialData = {
            hexes: {},
            rivers: [],
            roads: [],
            texts: [],
            borders: [],
            author: creator, // creator, never changed later
            editor: creator, // whoever last edited (starts as the creator)
    ...
    isConflictedHexPath(path) {
        return this.conflictOriginalPath(path) !== null;
    }

    // All conflict copies in the vault that belong to `originalPath` (so an open ORIGINAL can
    // point the user to its conflict copy, which they may otherwise never notice).
    findConflictCopies(originalPath) {
        return this.app.vault.getFiles().filter(f => this.conflictOriginalPath(f.path) === originalPath);
    }
    ...
    async ensureUserAssets(keys) {
        ...
        for (const key of new Set(keys)) {
            const registry = this.getRegistryForKey(key);
            if (registry) todo.push(registry.ensure(key));
        }
    ...
    async withExportResolution(keys, shortSideCap, fn) {
        ...
        const cap = Math.min(Math.round(shortSideCap), USER_ASSET_EXPORT_MAX_SHORT_SIDE);
        const restore = [];
        try {
            for (const key of new Set(keys)) {
                const registry = this.getRegistryForKey(key);
                ...
                if (!hiRes) continue;
                restore.push([asset, asset.image]);
                asset.image = hiRes;
            }
            return await fn();
        } finally {
            for (const [asset, image] of restore) asset.image = image;
        }
    }
    ...
    async reloadUserAssets(categoryIds = null, opts = null) {
        ...
        this.userAssetsPromise = Promise.all(ids.map(id => {
            const category = USER_ASSET_CATEGORIES.find(c => c.id === id);
            if (!category) return Promise.resolve();
            return this.userAssets.get(id).load(this.settings[category.settingKey]);
        }));
    ...
    handleAssetFileChange(file, oldPath) {
...
class HexCartographerView extends ItemView {
        ...
        this.toolConfigs = {
            ...
            tree: {
                ...
                variants: [
                    ...
                    { id: 'cactus', label: t('variant.cactus'), icon: 'sprout' },
                    { id: 'forest-deciduous', label: t('variant.forestDeciduous'), icon: 'trees' },
                    { id: 'forest-coniferous', label: t('variant.forestConiferous'), icon: 'triangle' }
                ],
            ...
            mountain: {
                ...
                variants: [
                    ...
                    { id: 'volcano', label: t('variant.volcano'), icon: 'volcano' }
                ],
                ...
                item.setTitle(t('menu.exportMap'))
                    ...
                    .onClick(() => {
                        ...
                        new ExportMapModal(this.app, mapSize, this.plugin.settings.exportWidth, async (format, width, quality, cropless) => {
                            const tmpCanvas = await this.renderFullMapForOutput({ targetWidth: width, cropless: cropless });
    ...
    async renderFullMapForOutput(opts = {}) {
        ...
        const keys = this.plugin.collectUsedAssetKeys(this.data);
        await this.plugin.ensureUserAssets(keys);

        const geo = this.computeExportGeometry(opts);
        if (!geo) return null;

        const needed = this.plugin.exportShortSideFor(this.data.gridSize, geo.scale);
    ...
    variantLabelFor(config, id) {
        ...
        if (isUserAssetKey(id)) {
            ...
            return asset ? asset.label : id.slice(id.indexOf(':', USER_ASSET_PREFIX.length) + 1);
        }
        return null;
    }
    ...
    renderSymbolButtonIcon(btn, symbolKey, fallbackIcon) {
        ...
        if (isUserAssetKey(symbolKey)) {
            const asset = this.plugin.getUserAsset(symbolKey);
            if (!asset) {
            ...
            if (asset.colorable) {
                this.setButtonPathIcon(btn, asset.pathData, asset.viewBoxWidth, asset.viewBoxHeight || asset.viewBoxWidth);
            } else {
                const img = btn.createEl('img', {
                    attr: { src: this.app.vault.adapter.getResourcePath(asset.filePath) }
                });
        ...
        const symbolInfo = this.svgSymbols[symbolKey];
        if (symbolInfo) {
            this.setButtonPathIcon(btn, symbolInfo.pathData, symbolInfo.viewBoxWidth, symbolInfo.viewBoxWidth);
        } else if (fallbackIcon) {
            setIcon(btn, fallbackIcon);
        }
    }

    setButtonPathIcon(btn, pathData, vbWidth, vbHeight) {
    ...
    async reloadFile() {
        ...
        try {
            ...
            // Compare without the viewport keys: those are device-local now, so a differing
            // pan/zoom must NOT count as a content change (it would force needless reloads).
            if (JSON.stringify(stripViewportKeys(this.data)) !== JSON.stringify(stripViewportKeys(newData))) {
                ...
                if (this.canvas) {
                    if (this.readViewport()) {
                        // Position now if the canvas is already sized (map switch on a
                        // reused view); on first open resizeCanvas applies it once the
                        // size is known.
            ...
            // Baseline for the no-op-save skip: the body exactly as just loaded from disk, so an
            // immediate save with no real change writes nothing and bumps no timestamp.
            this._lastSavedBody = this.serializedBody();
    ...
    async onOpen() {
        ...
        // Shown when the open map is an Obsidian Sync conflict copy: a resolve bar with
        // compare/rename/delete and a timestamp-based recommendation (see updateConflictBar).
        this.conflictBar = createDiv({ cls: 'hex-conflict-bar' });
        this.conflictBar.style.cssText = 'display: none; background: var(--interactive-accent); color: var(--text-on-accent); padding: 5px 10px; font-size: 13px; font-weight: 500; line-height: 1.4; box-shadow: 0 2px 6px rgba(0, 0, 0, 0.15);';
    ...
    createToolbar(toolbar) {
        ...
        this.hexColorBtn = hexColorBtn;
        this.updateHexColorButtonIcon(hexColorBtn);

        hexColorBtn.oncontextmenu = (e) => {
            e.preventDefault();
            this.showHexTextureMenu(hexColorBtn);
        };
    ...
    // action from the embedded lastModified + an order-independent identical-content check:
    // identical -> one-click delete; older -> delete (with confirm); newer -> compare first.
    async updateConflictBar() {
        const bar = this.conflictBar;
        if (!bar) return;
        const file = this.file;
        if (!file) { bar.style.display = 'none'; bar.empty(); return; }
        ...
        // Mode A: the open file IS a conflict copy -> resolve it.
        const originalPath = this.plugin.conflictOriginalPath(file.path);
        const original = originalPath ? this.app.vault.getAbstractFileByPath(originalPath) : null;

        // Read both versions to decide the recommendation (only when an original exists).
        let rec = 'neutral'; // 'identical' | 'older' | 'newer' | 'neutral'
        if (original instanceof TFile) {
            try {
                const [cText, oText] = await Promise.all([this.app.vault.read(file), this.app.vault.read(original)]);
                if (this.file !== file) return; // superseded during await
                const lm = (txt) => { try { const m = txt.match(/```json\s*([\s\S]*?)\s*```/); const d = JSON.parse(m ? m[1] : txt); return Number.isFinite(d.lastModified) ? d.lastModified : null; } catch (e) { return null; } };
                let same = false;
                try { same = mapContentSignature(cText) === mapContentSignature(oText); } catch (e) { same = false; }
                if (same) rec = 'identical';
                else {
                    const c = lm(cText), o = lm(oText);
                    if (c != null && o != null && c !== o) rec = c > o ? 'newer' : 'older';
                }
    ...
    makeHexImageSvg(src, size) {
        ...
        shape.setAttribute('points', this.hexPreviewPoints());
    ...
    makeAssetPreviewLabel(asset, kind, prefix = '') {
        ...
        if (kind === 'texture') {
            ...
            wrap.appendChild(this.makeSymbolImageHex(src, 22));
        }

        const span = document.createElement('span');
        span.textContent = prefix + asset.label;
    ...
    makeSystemSymbolPreviewLabel(variant, symbolColor) {
        ...
        if (info) {
            ...
            if (variant.icon) setIcon(icon, variant.icon);
    ...
    makeSymbolImageHex(src, size) {
        ...
        image.setAttribute('href', src);
        image.setAttribute('x', String(off));
        image.setAttribute('y', String(off));
        image.setAttribute('width', String(target));
    ...
    supportsSubmenus() {
        if (this._submenuSupport === undefined) {
            ...
            let ok = false;
            probe.addItem(item => { ok = typeof item.setSubmenu === 'function'; });
            this._submenuSupport = ok;
        }
    ...
    showVariantMenu(groupId, wrapper) {
        ...
        const selectVariant = async (id) => {
            ...
            this.renderSymbolButtonIcon(btn, id, this.variantIconFor(config, id));
        ...
        if (!registry || !registry.isActive) {
            ...
            menu.addItem(item => {
                ...
                addSystemVariants(this.tagScrollableMenu(item.setSubmenu()));
            });
            menu.addItem(item => {
    ...
    floodEraseColor(startHex, targetColor, targetTexture) {
        const visited = new Set();
        const queue = this.getHexNeighbors(startHex);
        ...
        while (queue.length > 0) {
            ...
            const hexData = this.data.hexes[key];
            if (!hexData) continue;
            if (hexData.color !== targetColor) continue;
            if ((hexData.texture || null) !== (targetTexture || null)) continue;
    ...
    floodFillColor(startHex, targetColor, newColor, targetTexture, newTexture) {
        ...
        while (queue.length > 0) {
            ...
            if (hexData) {
                ...
                if (!keepTexture) this.applyTexture(hexData, newTexture);
            } else {
                this.data.hexes[key] = { q: hex.q, r: hex.r, color: newColor };
                if (!keepTexture) this.applyTexture(this.data.hexes[key], newTexture);
            }
    ...
    tracehexPath(pos, radius, angleOffset) {
        ...
        for (let i = 0; i < 6; i++) {
            const a = (Math.PI / 180) * (60 * i + angleOffset);
            this.ctx.lineTo(pos.x + radius * Math.cos(a), pos.y + radius * Math.sin(a));
        }
        this.ctx.closePath();
    }
    ...
    requestAssetDecode(key) {
        ...
        this._pendingDecode.add(key);

        if (this._decodeTimer) return;
        this._decodeTimer = setTimeout(async () => {
            this._decodeTimer = null;
            const keys = [...this._pendingDecode];
            this._pendingDecode.clear();
            await this.plugin.ensureUserAssets(keys);
    ...
    isAssetPending(asset) {
        ...
        this.requestAssetDecode(asset.key);
        return true;
    }

    drawHexTexture(h, pos, radius, angleOffset) {
    ...
    // change: the device-local viewport and the lastModified/author/editor metadata. Used to
        ...
        if (this.file && await this.app.vault.adapter.exists(this.file.path)) {
            ...
            try {
                ...
                if (this.canvas && this.data.zoom) {
                    // Per-device viewport: this class's bucket plus the legacy mirror.
                    const cx = (this.canvas.width / 2 - this.data.offX) / this.data.zoom;
                    const cy = (this.canvas.height / 2 - this.data.offY) / this.data.zoom;
                ...
                // a different editor alone never counts as a change: no write (no Sync churn) and
                // no timestamp bump on a map that was only looked at / navigated.
                const body = this.serializedBody();
                if (body === this._lastSavedBody && this.file.path === this._lastSavedPath) {
                    this._dirty = false;
                    return;
                }

                // Real content change -> stamp when, and who edited. lastModified lives IN the
                // file, so "which version is newer" is reliable across devices (filesystem mtime
                // is not). `author` (the creator) is set once and preserved; `editor` is whoever
                // last edited. Empty author name -> the anonymous device id.
                const me = (this.plugin.settings.authorName || '').trim() || getDeviceId();
                if (!this.data.author) this.data.author = me;
                this.data.editor = me;
                ...
                // reloadFile ignore the delayed modify event of our own write.
    ...
    // stored viewports stay tiny (see writeViewport).
    deviceViewportClass() {
        ...
        return this.isTouchDevice ? 'phone' : 'desktop';
    }

    isValidViewport(vp) {
        return !!vp && Number.isFinite(vp.cx) && Number.isFinite(vp.cy) && Number.isFinite(vp.zoom) && vp.zoom > 0;
    }

    // The viewport to restore for THIS device. New maps keep one per class; if this
    // class has none yet (first time on this kind of device) we return null so the map
    // fits fresh to this screen — borrowing another class's viewport would bring back
    // the very desktop/mobile mismatch this feature fixes. Legacy maps (no per-device
    // store) fall back to the single top-level viewport, migrated as-is.
    // localStorage key for this map's viewport on THIS device class. Path-scoped so each
    // map keeps its own view; device-class-scoped so desktop/tablet/phone stay independent.
    viewportKey() {
        return 'hexcarto:viewport:' + (this.file ? this.file.path : '') + ':' + this.deviceViewportClass();
    }

    readLocalViewport() {
        try {
            const raw = window.localStorage.getItem(this.viewportKey());
            if (!raw) return null;
            const vp = JSON.parse(raw);
            return this.isValidViewport(vp) ? vp : null;
        } catch (e) { return null; }
    }

    readViewport() {
        // Device-local store (never synced) wins.
        const local = this.readLocalViewport();
        if (this.isValidViewport(local)) return local;
        // Migration/legacy: a viewport still stored IN the map file (older maps, or the first
        // load on this device before it moved to localStorage). Adopt it once, then persist
        // it locally so it survives the file dropping the viewport on the next save.
        let vp = null;
        const store = this.data.viewports;
        if (store) vp = store[this.deviceViewportClass()];
        if (!this.isValidViewport(vp) && this.data.settings && this.data.settings.viewportSaved &&
            Number.isFinite(this.data.centerWorldX) && Number.isFinite(this.data.centerWorldY) && this.data.zoom > 0) {
            vp = { cx: this.data.centerWorldX, cy: this.data.centerWorldY, zoom: this.data.zoom };
        }
        if (this.isValidViewport(vp)) {
            this.writeViewport(vp.cx, vp.cy, vp.zoom);
            return vp;
        }
        return null;
    }

    // Store the current viewport in localStorage only — never in the synced map file.
    writeViewport(cx, cy, zoom) {
        if (!Number.isFinite(cx) || !Number.isFinite(cy) || !(zoom > 0)) return;
        try {
            window.localStorage.setItem(this.viewportKey(), JSON.stringify({ cx, cy, zoom }));
        } catch (e) {}
    }

    // Places the canvas at this device's stored viewport. Needs canvas dimensions, so it
    // no-ops until the canvas is sized (then resizeCanvas calls it). Returns whether it
    // positioned anything.
    applyDeviceViewport() {
        const vp = this.readViewport();
        if (!vp || !this.canvas || !this.canvas.width) return false;
        this.data.zoom = vp.zoom;
        this.data.offX = this.canvas.width / 2 - vp.cx * vp.zoom;
        this.data.offY = this.canvas.height / 2 - vp.cy * vp.zoom;
        return true;
    }
    ...
    clearDecodeTimer() {
        if (this._decodeTimer) { clearTimeout(this._decodeTimer); this._decodeTimer = null; }
    }
...
function getFolderSuggestModal() {
    ...
    if (typeof FuzzySuggestModal !== 'function') return null;

    _FolderSuggestModal = class extends FuzzySuggestModal {
...
class InspectDuplicateModal extends Modal {
    ...
    buildSlider(container, oldUrl, newUrl) {
        ...
        // Grab handle ON the divider: a wide, invisible hit area with a small knob, so the line
        // can be dragged directly over the images — no need to scroll down to the range input
        // on a very tall map. pointer-events:auto re-enables events on this child of the (none) line.
        const handle = divider.createDiv();
        handle.style.cssText = 'position: absolute; top: 0; bottom: 0; left: -9px; width: 20px; cursor: ew-resize; pointer-events: auto;';
        const knob = handle.createDiv();
        knob.style.cssText = 'position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); width: 18px; height: 18px; border-radius: 50%; background: var(--interactive-accent); box-shadow: 0 0 0 2px #fff;';
        ...
        const pctFromX = (clientX) => {
            ...
            return rect.width ? Math.max(0, Math.min(100, ((clientX - rect.left) / rect.width) * 100)) : sliderVal;
        };
        // Drag the divider directly. `moved` tells the click handler below not to open the
        // lightbox when the gesture was a drag (a plain click still opens it).
        let dragging = false, moved = false;
        const onMove = (e) => { if (!dragging) return; moved = true; const v = pctFromX(e.clientX); setPos(v); range.value = String(Math.round(v)); };
        const endDrag = () => { dragging = false; document.removeEventListener('pointermove', onMove); document.removeEventListener('pointerup', endDrag); };
        handle.addEventListener('pointerdown', (e) => {
        ...
        // Click opens the lightbox on the side that was clicked (left = old, right = new) — but
        // not right after a drag. stopPropagation keeps Obsidian's own image-zoom from opening.
        wrap.onclick = (e) => {
            e.preventDefault();
            e.stopPropagation();
            if (moved) { moved = false; return; }
            this.openLightbox(oldUrl, newUrl, pctFromX(e.clientX) <= sliderVal);
        };
...
class HexCartographerSettingTab extends PluginSettingTab {
    ...
    display() {
        ...
        // Empty -> the anonymous per-device id is used instead. Groundwork for team features.
        const authorBody = makeSettingsSection('settings.authorSection',
            (this.plugin.settings.authorName || '') !== DEFAULT_SETTINGS.authorName);
        new Setting(authorBody)
            .setName(t('settings.authorName'))
            .setDesc(t('settings.authorNameDesc'))
            .addText(text => {
                text.setPlaceholder(t('settings.authorNamePlaceholder'))
        ...
        const addFolderSetting = (name, desc, settingKey, registry, categoryId) => {
            ...
            const statusEl = setting.descEl.createDiv({ attr: { style: 'margin-top: 4px; font-size: 12px;' } });
            ...
            const updateStatus = () => {
                ...
                if (registry.assets.size === 0) {
                    statusEl.setText(t('settings.userAssetsNotFound'));
                    statusEl.style.color = 'var(--text-error)';
                    return;
                }
                statusEl.setText(
                    t('settings.userAssetsFound').replace('{n}', String(registry.assets.size)) +
                    (registry.truncated ? ' ' + t('settings.userAssetsTruncated').replace('{max}', String(USER_ASSET_MAX_FILES)) : '')
                );
            ...
            const applyPath = async (raw) => {
                ...
                if (value === this.plugin.settings[settingKey]) return;
                this.plugin.settings[settingKey] = value;
                await this.plugin.saveSettings();
                await this.plugin.reloadUserAssets([categoryId]);
                updateStatus();
            };
            ...
            const Picker = getFolderSuggestModal();
            if (Picker) {
                setting.addExtraButton(btn => {
                    btn.setIcon('folder-open')
                        .setTooltip(t('settings.userAssetsBrowse'))
                        .onClick(() => {
                            new Picker(this.app, async (path) => {
            ...
            setting.addExtraButton(btn => {
                btn.setIcon('x')
                    .setTooltip(t('settings.userAssetsClear'))
                    .onClick(async () => {
                        textComp.setValue('');
                        await applyPath('');
                    });
        ...
        for (const category of USER_ASSET_CATEGORIES) {
            ...
            const name = isTexture
                ? t('settings.userTexturePath')
                : t('settings.userSymbolPathFor', { name: t(category.labelKey) });
            const desc = isTexture ? t('settings.userTexturePathDesc') : t('settings.userSymbolPathDesc');
            addFolderSetting(name, desc, category.settingKey, this.plugin.getRegistry(category.id), category.id);
        }
    ...
    buildGuide(containerEl) {
        ...
        const guide = [
            ...
            ['symbols', [
                ...
                [null, 'guide.symbols.userSymbols'],
            ]],
            ['drawing', [
...
const SVG_SYMBOL_DATA = {
    ...
    'cactus': { pathData: 'M148.48,122.65l.82-7.61c.1-3.3.12-6.12-.63-9.33-1.82-7.86-6.72-14.49,1.18-20.84s18.01-2.17,21.53,6.99c2.56,6.67,4.88,14.85,6.07,21.88.54,3.17.33,6.26.36,9.47,3.09-1.01,3.95-3.02,7.62-2.78,6.73.45,9.24,8.95,9.54,14.54.67,12.65-3.51,22.17-7.55,33.69-1.8,5.13-3.9,9.53-7.68,13.63-4.06,4.41-11.46,6.42-17.3,7.06-2.52.28-5.41,0-7.72.31-.4.06-1.41.27-1.52.69,1.09,5.94,2.66,11.85,3.76,17.78,3.18,17.12,5.57,38.14,1.34,55.15-.68,2.72-1.67,5.71-4.5,6.85-3.72,1.5-12.71,2.84-15.45-.77-1.23-1.62-2.82-7.01-3.33-9.13-2.27-9.6-3.67-19.96-4.56-29.77-.94-10.4-1.71-20.94-2.54-31.28-.19-2.39-.73-4.76-.81-7.16-.09-.36-.34-.4-.65-.45-1.31-.24-3.07-.12-4.58-.4-1.66-.31-3.4-1.21-4.9-1.47-3.66-.64-5.81-.31-9.06-2.84-8.27-6.44-13.19-29.92-15.46-40.18-1.67-7.55-4.12-18.23-3.52-25.84.67-8.49,12.43-16.05,19.53-9.55,9.36,8.57,8.07,25.75,11.06,36.83.19.69,3.27,7.24,4.3,6.08.28-1.61-.3-3.34-.3-4.84.01-15.14-5.14-30.95-7.14-45.99-.9-6.76-.75-13.65-1.45-20.41-2.06-19.9-9.33-41.32-6.88-61.49.85-6.97,2.55-10.13,9.47-12.12,16.07-4.62,15.35,15.63,17.18,25.87,2.4,13.44,5.06,26.75,7.06,40.27,1.61,10.92,3.06,21.74,4.71,32.66.73,4.82,1,9.71,1.98,14.49h.02ZM123.76,11.69l-1.02.93c1.82,1.06,3.31,2.59,4.56,4.29,1.24.03-.04-2.68-.41-3.19s-2.53-2.19-3.13-2.03ZM116.92,12.48c-2.47-.26-4.06,3.5-4.57,5.53-2.78,11.12-.31,29.6,1.57,41.07,1.11,6.8,3.05,13.46,4.07,20.29,2.47,16.62,4.09,33.39,6.76,49.99.89,5.54,2.44,11.19,3.21,16.72